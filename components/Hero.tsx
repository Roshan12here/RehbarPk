...
const HeroSection = () => {
  return (
    ...
    <div className="relative w-full rounded-3xl lg:w-[90%] mt-2 xl:w-[90%] 2xl:w-[90%] h-[78vh] bg-cover bg-center mx-auto" style={{ backgroundImage: "url('/fa.jpg')" }}>
      ...
      <h1 className="text-[2rem] sm:text-[2rem] md:text-3xl lg:text-3xl font-poppins mb-3 leading-tight">
  ...
  <br className='hidden lg:block' />  and <span className="font-extrabold">Businesses</span> in Pakistan
        ...
        <div className="flex  justify-center space-x-8 sm:space-x-16 md:mt-24 lg:mt-28 xl:mt-36 mt-24 sm:mt-24">
          <div>
            <p className="text-xl sm:text-xl md:text-2xl font-bold">15k+</p>
            <p className="text-xs sm:text-sm">Businesses</p>
          </div>
          <div>
            <p className="text-xl sm:text-xl md:text-2xl font-bold">10k+</p>
            <p className="text-xs sm:text-sm">Destinations</p>
          </div>
          <div>
            <p className="text-xl sm:text-xl md:text-2xl font-bold">1m+</p>
