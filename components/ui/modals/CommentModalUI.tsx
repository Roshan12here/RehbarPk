      ...
      <Dialog onClose={() => setVisible(false)} static={true} open={visible}>
        ...
        >
          <div className='fixed inset-0 z-50 flex items-center justify-center'>
            <Dialog.Panel className='relative w-full max-w-2xl p-6 bg-white rounded-lg shadow-lg max-h-[500px]'>
              ...
              <div className='flex justify-center flex-col flex-1 px-4 py-6 text-left overflow-auto'>
                {children}
              </div>
            </Dialog.Panel>
          </div>
