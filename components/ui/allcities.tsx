  ...
  const handleCategoryToggle = (category: string) => {
    ...
    >
      <h1 className="text-4xl font-semibold text-center">
        📊 From Which City Are you Searching For Destinations
      </h1>
      <p className="text-xl font-light mt-4 leading-8 text-center">
        
You can Pick a City where you want to travel and discover some amazing Destinations
      </p>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-4 mt-4">
          {citiess.map((category, index) => (
            <motion.div
              ...
              whileTap={{ scale: 0.9 }}
            >
              <Link href={`/Destinations/${category.toLowerCase()}`}>
              <div
