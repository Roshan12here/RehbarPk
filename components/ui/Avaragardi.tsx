...
export default function Component() {
  return (
<header className="h-screen relative w-full bg-[url('/awara.jpg')] bg-cover bg-center bg-no-repeat py-8 md:py-12 lg:py-16">
{/* Dark overlay */}
  ...
  <span className="text-sm text-yellow-500 mt-20 ml-[-2vw] lg:text-base xl:text-lg">By hh Rehbar.pk</span>
</div>
