...
import { updateProduct } from "@/lib/Business-server-action";
      ...
      toast(
        <>
          <div className="flex items-center gap-4  mx-auto">
            ...
            <div className="text-md font-semibold">
              There was an error updating the Business
              {error.message}
            </div>
          </div>
        </>,
    ...
    <div className="h-full">
      ...
      <div className="w-full rounded-md p-10 bg-emerald-100 mt-10 md:flex items-center gap-x-4">
        ...
        <div className="text-gray-600">
          This is the Business form. You can update the Business details here. If
          your Business is currently live, and you make changes to the Business
          details. It will delist the Business from the marketplace until it is
