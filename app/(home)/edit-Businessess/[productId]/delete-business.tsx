...
import { deleteProduct } from "@/lib/Business-server-action";
    ...
    justify-center rounded-md items-center flex"
      ...
      >
        <div>
          ...
          <p className="text-sm">
            We&apos;re sorry to see you go. Once your Business is deleted, all of
            your content will be permanently gone, including your Businees and
            Businees settings.
          </p>

          <p className="text-sm py-10">
            This action cannot be undone. This will permanently delete your
            Businees and all of your content.
          </p>
