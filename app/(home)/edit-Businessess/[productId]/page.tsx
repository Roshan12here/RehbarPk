...
import { getProductById, getRankById } from "@/lib/Business-server-action";
import Image from "next/image";
import Link from "next/link";
import { PiArrowLeft } from "react-icons/pi";
import EditProduct from "./edit-business";
import DeleteProduct from "./delete-business";
...
const ProductIDPage = async ({ params }: { params: IParams }) => {
  ...
  return (
    <div className="md:w-4/5 mx-auto px-6 md:px-0 py-10">
      <Link href="/my-\Businesses" className="flex gap-x-4">
